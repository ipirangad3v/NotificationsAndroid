...
object NotificationUtils {
    ...
    fun notificationAutoReply(context: Context) {
        ...
        val replyPensingIntent = PendingIntent.getBroadcast(
        ...
        val action = NotificationCompat.Action.Builder(
            R.drawable.ic_send,
            context.getString(R.string.notif_reply_label), replyPensingIntent
        )
        ...
        val notificationBuilder = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setContentText(context.getString(R.string.notif_text))
            .setPriority(NotificationCompat.PRIORITY_DEFAULT)
            .setColor(ActivityCompat.getColor(context, R.color.design_default_color_primary_dark))
            .setDefaults(Notification.DEFAULT_ALL)
            .addAction(action)
        val notificationManager = NotificationManagerCompat.from(context)
